...
var UserService = /** @class */ (function () {
    function UserService(userStorageService, developerStashService) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.userStorageService.get(filter, search, limit)];
    ...
    UserService.prototype.add = function (obj) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(obj.stashDisplayName.length !== 0)) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.developerStashService.getValidDeveloper(obj.stashDisplayName)];
                    case 1:
                        validDeveloper = _a.sent();
                        if (!(typeof validDeveloper !== 'string')) return [3 /*break*/, 3];
                        obj.stashSlug = validDeveloper.slug;
                        return [4 /*yield*/, this.userStorageService.add(obj)];
                    case 2: return [2 /*return*/, (_a.sent()) ? obj : ServiceErrorMessages_1.default.DB];
                    case 3: return [2 /*return*/, validDeveloper];
                    case 4: return [2 /*return*/, ServiceErrorMessages_1.default.STASH_NAME_NOT_GIVEN];
                }
            });
        });
    };
    UserService.prototype.delete = function (obj) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userStorageService.remove(obj)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
