...
var DeveloperToMsgAdapter = /** @class */ (function () {
    ...
    DeveloperToMsgAdapter.prototype.getDevelopersListMsg = function (builder, channelId) {
        return __awaiter(this, void 0, void 0, function () {
            var emptyDevelopersMsg, users;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        users = _a.sent();
                        if (users.length === 0) {
                            return [2 /*return*/, builder.buildSection(emptyDevelopersMsg).getMessage()];
                        }
                        else {
                            return [2 /*return*/, buildDevelopersList_1.default(builder, users)];
                        }
                        return [2 /*return*/];
                }
            });
    ...
    DeveloperToMsgAdapter.prototype.getAddResultMsg = function (builder, obj) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    return DeveloperToMsgAdapter;
}());
exports.default = DeveloperToMsgAdapter;
