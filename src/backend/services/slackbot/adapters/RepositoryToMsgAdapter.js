...
var RepositoryToMsgAdapter = /** @class */ (function () {
    ...
    RepositoryToMsgAdapter.prototype.getReposListMsg = function (builder, channelId) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        repos = _a.sent();
                        if (repos.length === 0) {
                            emptyReposMsg = "You don't have added repositories yet. To add them please use command /add_repository";
                            return [2 /*return*/, builder.buildSection(emptyReposMsg).getMessage()];
                        }
                        else {
                            return [2 /*return*/, buildRepositoriesList_1.default(builder, repos)];
                        }
                        return [2 /*return*/];
                }
            });
    ...
    RepositoryToMsgAdapter.prototype.getAddResultMsg = function (builder, obj) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    return RepositoryToMsgAdapter;
}());
exports.default = RepositoryToMsgAdapter;
