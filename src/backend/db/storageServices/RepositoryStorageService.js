...
var RepositoryStorageService = /** @class */ (function (_super) {
    ...
    RepositoryStorageService.prototype.get = function (filter) {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, docs.map(function (doc) {
                                return ({ reponame: doc.reponame, url: doc.url, channelId: doc.channelId, addedByName: doc.addedByName, id: doc._id });
                            })];
                }
            });
        });
...
exports.default = RepositoryStorageService;
