...
var SubscribeStorageService = /** @class */ (function (_super) {
    ...
    function SubscribeStorageService() {
        return _super.call(this, SubscribeModel_1.SubscribeModel) || this;
    }
    SubscribeStorageService.prototype.get = function (filter, search, limit) {
        return __awaiter(this, void 0, void 0, function () {
            var docs;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.model.find(filter).sort({ reponame: 1 }).exec()];
                    case 1:
                        docs = _a.sent();
...
exports.default = SubscribeStorageService;
