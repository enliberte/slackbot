...
var FavoriteDevelopers = function (_a) {
    ...
    return (react_1.default.createElement(ListItem_1.default, { button: true, onClick: function () { return setDeveloper(developer.username); } },
...
exports.default = react_redux_1.connect(null, mapDispatchToProps)(FavoriteDevelopers);
