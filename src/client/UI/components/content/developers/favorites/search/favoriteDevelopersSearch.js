...
var FavoriteDevelopersSearch = function (_a) {
...
var mapStateToProps = function (state) { return ({
    search: developers_1.selectSearchFavoriteDevelopersTerm(state)
}); };
var mapDispatchToProps = function (dispatch) { return ({
    handleSearch: function (event) {
        dispatch(developersActionCreators_1.searchFavoriteDevelopers(event.target.value));
    }
}); };
exports.default = react_redux_1.connect(mapStateToProps, mapDispatchToProps)(FavoriteDevelopersSearch);
