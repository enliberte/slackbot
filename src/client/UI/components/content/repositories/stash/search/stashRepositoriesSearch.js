...
var StashRepositoriesSearch = function (_a) {
...
var mapStateToProps = function (state) { return ({
    search: repositories_1.selectFilterStashRepositoriesTerm(state)
}); };
var mapDispatchToProps = function (dispatch) { return ({
    handleSearch: function (event) {
        dispatch(repositoriesActionCreators_1.filterStashRepositories(event.target.value));
    }
}); };
exports.default = react_redux_1.connect(mapStateToProps, mapDispatchToProps)(StashRepositoriesSearch);
