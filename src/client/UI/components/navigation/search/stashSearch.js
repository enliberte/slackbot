...
var StashSearch = function (_a) {
    var filter = _a.filter, handleSearch = _a.handleSearch;
    ...
    return (react_1.default.createElement("div", { className: classes.search },
        ...
        react_1.default.createElement(InputBase_1.default, { placeholder: "Search\u2026", classes: {
            ...
            }, inputProps: { 'aria-label': 'search' }, value: filter, onChange: handleSearch })));
};
var mapStateToProps = function (state) { return ({
    filter: developers_1.selectFilterStashDevelopersTerm(state)
}); };
exports.default = react_redux_1.connect(mapStateToProps)(StashSearch);
