...
var authWatchers_1 = require("./watchers/authWatchers");
var developersWatchers_1 = require("./watchers/developersWatchers");
var subscribesWatchers_1 = require("./watchers/subscribesWatchers");
var repositoriesWatchers_1 = require("./watchers/repositoriesWatchers");
function rootSaga() {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, effects_1.all([
                    ...
                    developersWatchers_1.watchDeleteFavoriteDeveloper(),
                    developersWatchers_1.watchAddStashDeveloperToFavorites(),
